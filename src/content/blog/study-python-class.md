...
description: "클래스(class)란 실세계의 것을 모델링해 속성(attribute)와 동작(method)를 갖는 데이터 타입이다."
pubDate: 2024-03-01
...
오버라이딩 가능한 함수 목록 : [Data model](https://docs.python.org/3/reference/datamodel.html), [Python Magic Method 사용법](https://zzsza.github.io/development/2020/07/05/python-magic-method/)
...
- __doc__는 자동으로 생성되는 **멤버 변수**다. docstring이라고 한다.
...
- **초기자(생성자, __init__)** : 생성된 인스턴스의 개수를 카운팅한다.
- **소멸자(__del__)** : 인스턴스를 삭제한다.
