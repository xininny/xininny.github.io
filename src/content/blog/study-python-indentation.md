---
title: "Python | 5. 들여쓰기"
description: "파이썬 언어는 왼쪽으로 맞추지 않으면 에러가 발생한다."
pubDate: 2024-02-18
...
- 주석을 설명한 페이지 : [Python | 1. 함수, 내장함수, Print 함수](https://xininny.github.io/python/function/)

파이썬에서 주석은 들여쓰기를 지키지 않아도 된다. 하지만 파이썬에서 """ … """ 문장은 주석이 아니다.
